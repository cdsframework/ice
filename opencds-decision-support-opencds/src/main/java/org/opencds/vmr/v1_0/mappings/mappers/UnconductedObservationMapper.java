...
{
    public static void pullIn(final org.opencds.vmr.v1_0.schema.UnconductedObservation source, final UnconductedObservation target,
    ...
    public static org.opencds.vmr.v1_0.schema.UnconductedObservation pushOut(final UnconductedObservation source,
            final OrganizedResults organizedResults) throws ImproperUsageException, DataFormatException, InvalidDataException
    {
        ...
        final org.opencds.vmr.v1_0.schema.UnconductedObservation target = new org.opencds.vmr.v1_0.schema.UnconductedObservation();
        ...
        if (organizedResults.getOutput().getUnconductedObservations() == null)
        {
            organizedResults.getOutput()
                    .setUnconductedObservations(
                            new org.opencds.vmr.v1_0.schema.EvaluatedPerson.ClinicalStatements.UnconductedObservations());
        }
