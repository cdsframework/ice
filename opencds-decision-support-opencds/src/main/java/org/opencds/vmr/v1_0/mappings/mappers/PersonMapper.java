...
{
    public static Person pullIn(final org.opencds.vmr.v1_0.schema.Person source, final Person target, final String parentId,
    ...
    public static org.opencds.vmr.v1_0.schema.Person pushOut(final Person source, final org.opencds.vmr.v1_0.schema.Person target)
    {
        return target;
    }
