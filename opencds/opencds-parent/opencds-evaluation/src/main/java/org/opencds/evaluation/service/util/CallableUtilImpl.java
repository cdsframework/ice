...
public class CallableUtilImpl implements CallableUtil {
	...
	public Callable<EvaluationResponseKMItem> getCallable(KnowledgeRepository knowledgeRepository,
        ...
        if (adapter == null) {
        	throw new OpenCDSRuntimeException("Cannot find adapter for ExecutionEngine: " + engine.getIdentifier());
        }
        return ExecutionEngineAdapterCallable.create(adapter, engine, knowledgeRepository,
