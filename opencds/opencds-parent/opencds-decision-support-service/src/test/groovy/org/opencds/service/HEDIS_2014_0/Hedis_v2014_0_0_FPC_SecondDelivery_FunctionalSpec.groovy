...
public class Hedis_v2014_0_0_FPC_SecondDelivery_FunctionalSpec extends Specification {
...
//	private static final String FPC_056 = "src/test/resources/samples/hedis-fpc/FPC_056.xml"	
	...
	@Unroll
	def "test HEDIS FPC_secondDelivery"() {
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_FPC_SecondDelivery', version: '2014.0.0'],
