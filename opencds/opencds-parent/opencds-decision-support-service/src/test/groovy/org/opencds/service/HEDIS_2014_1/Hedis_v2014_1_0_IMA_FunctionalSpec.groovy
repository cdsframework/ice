...
public class Hedis_v2014_1_0_IMA_FunctionalSpec extends Specification {
...
//	
	...
	def "test HEDIS IMA"() {
		...
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_IMA', version: '2014.1.0'],
