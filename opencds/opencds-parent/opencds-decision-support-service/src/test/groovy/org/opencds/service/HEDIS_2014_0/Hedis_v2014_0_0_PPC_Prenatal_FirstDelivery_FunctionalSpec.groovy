...
public class Hedis_v2014_0_0_PPC_Prenatal_FirstDelivery_FunctionalSpec extends Specification {
...
/* Assumptions: Measurement Year is 2011, encounter low date is proxy for delivery date */
	...
	@Unroll
	def "test HEDIS PPC Prenatal firstDelivery"() {
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_PPC_Prenatal_FirstDelivery', version: '2014.0.0'],
...
//		}
		...
		vmr | measureFocus | denominator | numerator 
			 ...
			 * C2648 - PPC Prenatal First Delivery
			 */
