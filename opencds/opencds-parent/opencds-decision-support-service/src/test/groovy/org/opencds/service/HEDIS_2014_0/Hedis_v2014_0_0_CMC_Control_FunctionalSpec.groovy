...
public class Hedis_v2014_0_0_CMC_Control_FunctionalSpec extends Specification {
...
//    private static final String CMC_C0022 = "H:/KMM ITS/Projects/OpenCDS/Quality Measures/HEDIS/testing/cmc-phi.xml"
	...
	@Unroll
	def "test HEDIS CMC control"() {
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_CMC_Control', version: '2014.0.0'],
...
//			specifiedTime: '2014-01-01'
		...
		CMC_C0014 | [C2606: '', C341: '', C54: '', numNotMet: '', wrapper : ''] | '1' | '0'
		CMC_C0015 | [C2606: '', C341: '', C54: '', numNotMet: '', wrapper : ''] | '1' | '0'
		CMC_C0016 | [C2606: '', C341: '', C54: '', numNotMet: '', wrapper : ''] | '1' | '0'
		CMC_C0017 | [C2606: '', C341: '', C54: '',C2736:'',C539:'', numMet: '', wrapper : ''] | '1' | '1'
		CMC_C0018 | [C2606: '', C341: '', C54: '',C2736:'',C539:'', numMet: '', wrapper : ''] | '1' | '1'
		CMC_C0019 | [C2606: '', C341: '', C54: '', numNotMet: '', wrapper : ''] | '1' | '0'
		CMC_C0020 | [C2606: '', C341: '', C54: '', numNotMet: '', wrapper : ''] | '1' | '0'
		CMC_C0021 | [C2606: '', C341: '', C54: '', numNotMet: '', wrapper : ''] | '1' | '0'
