...
public class Hedis_v2014_0_0_PPC_Prenatal_SecondDelivery_FunctionalSpec extends Specification {
...
/* Assumptions: Measurement Year is 2011, encounter low date is proxy for delivery date */
	...
	@Unroll
	def "test HEDIS PPC Prenatal secondDelivery"() {
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_PPC_Prenatal_SecondDelivery', version: '2014.0.0'],
...
//		}
		...
		vmr | measureFocus | denominator | numerator 
			 ...
			 * C3311 - PPC Prenatal First Delivery
			 */
