...
public class KieBaseAdapter implements ExecutionEngineAdapter<List<Command<?>>, ExecutionResults, KieBase> {
    private static Log log = LogFactory.getLog(KieBaseAdapter.class);

    @Override
    public ExecutionEngineContext<List<Command<?>>, ExecutionResults> execute(KieBase kieBase,
