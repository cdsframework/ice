...
package org.opencds.hooks.model.dstu2.support;
...
public class ResourceJsonSupport implements JsonDeserializer<Resource>, JsonSerializer<Resource> {
	...
	private static final FhirContext ctx = FhirContextFactory.get(FhirVersionEnum.DSTU2_HL7ORG);
	...
	public Resource deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
		...
		try {
			Class<? extends Resource> resourceClass = (Class<? extends Resource>) Class.forName("org.hl7.fhir.dstu2.model." + resourceType);
