...
import org.opencds.hooks.model.r5.support.ActionJsonSupport;
import org.opencds.hooks.model.r5.support.ResourceJsonSupport;
import org.opencds.hooks.model.response.Action;
import org.opencds.hooks.model.util.ClassUtil;

public class R5JsonUtil extends CdsHooksJsonUtil {
    ...
    public R5JsonUtil() {
        ...
        // FHIR
        ClassUtil.getResourceClassesAssignableFrom("org.hl7.fhir.r5.model", Resource.class)
