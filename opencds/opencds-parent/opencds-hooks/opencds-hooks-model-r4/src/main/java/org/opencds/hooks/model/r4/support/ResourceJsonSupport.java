...
package org.opencds.hooks.model.r4.support;
...
public class ResourceJsonSupport implements JsonDeserializer<Resource>, JsonSerializer<Resource> {
	...
	private static final FhirContext ctx = FhirContextFactory.get(FhirVersionEnum.R4);
	...
	public Resource deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
		...
		try {
			Class<? extends Resource> resourceClass = (Class<? extends Resource>) Class.forName("org.hl7.fhir.r4.model." + resourceType);
