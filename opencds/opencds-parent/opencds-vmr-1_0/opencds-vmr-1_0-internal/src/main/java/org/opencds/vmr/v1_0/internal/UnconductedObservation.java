...
public class UnconductedObservation extends ObservationBase {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnconductedObservation other = (UnconductedObservation) obj;
	...
	public String toString() {
		return super.toString()
				+ ", UnconductedObservation [reason=" + reason
