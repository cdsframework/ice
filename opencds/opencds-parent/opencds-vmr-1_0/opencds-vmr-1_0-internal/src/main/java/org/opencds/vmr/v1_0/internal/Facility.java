...
/**
 * A property such as a building that has been established to enable the performance of specific activities, typically be organizations.  
 * E.g., a hospital or clinic.
 */
public class Facility extends EntityBase
{
	...
	public String toString() {
		return "Facility [" + super.toString() + ", name=" + name + ", address=" + address + ", telecom="
				+ telecom + "]";
	}
