...
/*
 * A clinical appointment that has been scheduled.  If rescheduled, the appointmentTime may change.
 */
...
public class ScheduledAppointment extends EncounterBase {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScheduledAppointment other = (ScheduledAppointment) obj;
	...
	public String toString() {
		return super.toString()
				+ ", ScheduledAppointment [appointmentTime=" + appointmentTime
				+ "]";
	}
