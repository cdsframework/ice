...
public class UndeliveredSupplyMapper extends SupplyBaseMapper {
	...
	private static Log logger = LogFactory.getLog(UndeliveredSupplyMapper.class);
	...
	public static void pullIn(
			org.opencds.vmr.v1_0.schema.UndeliveredSupply 	source, 
			UndeliveredSupply								target, 
	 ...
	 * @throws InvalidDataException
	 */
	public static org.opencds.vmr.v1_0.schema.UndeliveredSupply pushOut(
			UndeliveredSupply 								source, 
			org.opencds.vmr.v1_0.schema.UndeliveredSupply	target, 
		...
		target = new org.opencds.vmr.v1_0.schema.UndeliveredSupply();
		...
		if (organizedResults.getOutput().getUndeliveredSupplies() == null) {
			organizedResults.getOutput().setUndeliveredSupplies(new org.opencds.vmr.v1_0.schema.EvaluatedPerson.ClinicalStatements.UndeliveredSupplies());
		}
