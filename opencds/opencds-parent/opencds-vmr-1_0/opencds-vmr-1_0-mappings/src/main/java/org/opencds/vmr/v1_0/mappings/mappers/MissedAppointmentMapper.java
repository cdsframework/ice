...
public class MissedAppointmentMapper extends EncounterBaseMapper {
	...
	private static Log logger = LogFactory.getLog(MissedAppointmentMapper.class);
	...
	public static void pullIn(
			org.opencds.vmr.v1_0.schema.MissedAppointment	source, 
			MissedAppointment 								target, 
	 ...
	 * @throws InvalidDataException
	 */
	public static org.opencds.vmr.v1_0.schema.MissedAppointment pushOut(
			MissedAppointment 								source, 
			org.opencds.vmr.v1_0.schema.MissedAppointment	target, 
		...
		target = new org.opencds.vmr.v1_0.schema.MissedAppointment();
		...
		if (organizedResults.getOutput().getMissedAppointments() == null) {
			organizedResults.getOutput().setMissedAppointments(new org.opencds.vmr.v1_0.schema.EvaluatedPerson.ClinicalStatements.MissedAppointments());
		}
