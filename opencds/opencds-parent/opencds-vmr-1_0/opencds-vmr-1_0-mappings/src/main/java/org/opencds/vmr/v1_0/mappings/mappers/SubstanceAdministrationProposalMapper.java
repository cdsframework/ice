...
public class SubstanceAdministrationProposalMapper extends SubstanceAdministrationBaseMapper {
	...
	private static Log logger = LogFactory.getLog(SubstanceAdministrationProposalMapper.class);
	...
	public static void pullIn(
			org.opencds.vmr.v1_0.schema.SubstanceAdministrationProposal source, 
			SubstanceAdministrationProposal 							target, 
		...
		if ( source.getProposedAdministrationTimeInterval() != null ) target.setProposedAdministrationTimeInterval(MappingUtility.iVLTS2IVLDateInternal(source.getProposedAdministrationTimeInterval()));
		if ( source.getValidAdministrationTimeInterval() != null ) target.setValidAdministrationTimeInterval(MappingUtility.iVLTS2IVLDateInternal(source.getValidAdministrationTimeInterval()));
		if ( source.getValidAdministrationTimeInterval() != null ) target.setNumberFillsAllowed(MappingUtility.iNT2INTInternal(source.getNumberFillsAllowed()));
	 ...
	 * @throws InvalidDataException
	 */
	public static org.opencds.vmr.v1_0.schema.SubstanceAdministrationProposal pushOut(
			SubstanceAdministrationProposal 							source, 
		...
		target = new org.opencds.vmr.v1_0.schema.SubstanceAdministrationProposal();
		...
		if ( source.getProposedAdministrationTimeInterval() != null ) target.setProposedAdministrationTimeInterval(MappingUtility.iVLDateInternal2IVLTS(source.getProposedAdministrationTimeInterval()));
		if ( source.getValidAdministrationTimeInterval() != null ) target.setNumberFillsAllowed(MappingUtility.iNTInternal2INT(source.getNumberFillsAllowed()));
		if ( source.getValidAdministrationTimeInterval() != null ) target.setValidAdministrationTimeInterval(MappingUtility.iVLDateInternal2IVLTS(source.getValidAdministrationTimeInterval()));
		...
		if (organizedResults.getOutput().getSubstanceAdministrationProposals() == null) {
			organizedResults.getOutput().setSubstanceAdministrationProposals(new org.opencds.vmr.v1_0.schema.EvaluatedPerson.ClinicalStatements.SubstanceAdministrationProposals());
		}
