...
public class UndeliveredProcedureMapper extends ProcedureBaseMapper {
	...
	private static Log logger = LogFactory.getLog(UndeliveredProcedureMapper.class);
	...
	public static void pullIn(
			org.opencds.vmr.v1_0.schema.UndeliveredProcedure	source, 
			UndeliveredProcedure								target, 
	 ...
	 * @throws InvalidDataException
	 */
	public static org.opencds.vmr.v1_0.schema.UndeliveredProcedure pushOut(
			UndeliveredProcedure 								source, 
			org.opencds.vmr.v1_0.schema.UndeliveredProcedure	target, 
		...
		target = new org.opencds.vmr.v1_0.schema.UndeliveredProcedure();
		...
		if (organizedResults.getOutput().getUndeliveredProcedures() == null) {
			organizedResults.getOutput().setUndeliveredProcedures(new org.opencds.vmr.v1_0.schema.EvaluatedPerson.ClinicalStatements.UndeliveredProcedures());
		}
