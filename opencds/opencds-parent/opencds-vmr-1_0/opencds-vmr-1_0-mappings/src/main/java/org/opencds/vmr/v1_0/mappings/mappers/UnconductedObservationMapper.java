 ...
 *
 */
public class UnconductedObservationMapper extends ObservationBaseMapper {
	private static Log logger = LogFactory.getLog(UnconductedObservationMapper.class);
	...
	public static void pullIn(
			org.opencds.vmr.v1_0.schema.UnconductedObservation	source, 
			UnconductedObservation								target, 
		...
		factLists.put(UnconductedObservation.class, target);
	 ...
	 * @throws InvalidDataException
	 */
	public static org.opencds.vmr.v1_0.schema.UnconductedObservation pushOut(
			UnconductedObservation 								source, 
			org.opencds.vmr.v1_0.schema.UnconductedObservation	target, 
		...
		target = new org.opencds.vmr.v1_0.schema.UnconductedObservation();
		...
		if (organizedResults.getOutput().getUnconductedObservations() == null) {
			organizedResults.getOutput().setUnconductedObservations(new org.opencds.vmr.v1_0.schema.EvaluatedPerson.ClinicalStatements.UnconductedObservations());
		}
