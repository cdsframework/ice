...
public class ScheduledAppointmentMapper extends EncounterBaseMapper {
	...
	private static Log logger = LogFactory.getLog(ScheduledAppointmentMapper.class);
	...
	public static void pullIn(
			org.opencds.vmr.v1_0.schema.ScheduledAppointment 	source, 
			ScheduledAppointment 								target, 
		...
		if ( source.getAppointmentTime() != null ) target.setAppointmentTime(MappingUtility.iVLTS2IVLDateInternal(source.getAppointmentTime()));
	 ...
	 * @throws InvalidDataException
	 */
	public static org.opencds.vmr.v1_0.schema.ScheduledAppointment pushOut(
			ScheduledAppointment 								source, 
			org.opencds.vmr.v1_0.schema.ScheduledAppointment	target, 
		...
		target = new org.opencds.vmr.v1_0.schema.ScheduledAppointment();
		...
		if ( source.getAppointmentTime() != null ) target.setAppointmentTime(MappingUtility.iVLDateInternal2IVLTS(source.getAppointmentTime()));
		...
		if (organizedResults.getOutput().getScheduledAppointments() == null) {
			organizedResults.getOutput().setScheduledAppointments(new org.opencds.vmr.v1_0.schema.EvaluatedPerson.ClinicalStatements.ScheduledAppointments());
		}
