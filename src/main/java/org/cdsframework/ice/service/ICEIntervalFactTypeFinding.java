...
public class ICEIntervalFactTypeFinding extends ICEFactTypeFinding
{
    ...
    private final TargetDose currentTargetDose;
    private final IntervalFactType intervalFactType;
     ...
     */
    public ICEIntervalFactTypeFinding(final String pIceResultFinding, final TargetDose pPreviousTargetDose,
            final TargetDose pTargetDose)
    {
     ...
     */
    public ICEIntervalFactTypeFinding(final String pIceResultFinding, final TargetDose pTargetDose)
    {
