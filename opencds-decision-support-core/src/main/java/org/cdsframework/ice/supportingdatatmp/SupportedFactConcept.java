...
{
    _ADOLESCENT_TDAP_5_DOSE_SERIES_RECOMMENDATION_EXCEPTION("ICE_FACT_ADOLESCENT_TDAP_5_DOSE_SERIES_RECOMMENDATION_EXCEPTION",
            "Adolescent Tdap 5 Dose Series Recommendation"),
    ...
    _CANDIDATE_SERIES_IDENTIFICATION_DEFAULT_RULE_OVERRIDE("ICE_FACT-CANDIDATE_SERIES_IDENTIFICATION_DEFAULT_RULE_OVERRIDE",
            "Override series Identification Default Logic"),
    ...
    _DT_ADMINISTERED_ON_OR_AFTER_20230501_EVALUATE_AS_CVX_107("ICE_FACT-DT_ADMINISTERED_ON_OR_AFTER_20230501_EVALUATE_AS_CVX_107",
            "DT administered on or after 2023-05-01 should be evaluated as CVX 107"),
    ...
    _OUTPUT_SCHEDULE_AUTHORITIES("ICE_FACT-OUTPUT_SCHEDULE_AUTHORITIES", "Output schedule authorities"),
    _OUTPUT_SERIES_INFORMATION("ICE_FACT-OUTPUT_SERIES_INFORMATION", "Output series names for evaluations and proposals"),
    _PNEUMOCOCCAL_CHILD_SERIES_COMPLETE("ICE_FACT-PNEUMOCOCCAL_CHILD_SERIES_COMPLETE", "Pneumococcal- Child Series Complete"),
    _PNEUMOCOCCAL_EVALUATION_CHILD_RECEIVED_PCV13_DOSE("ICE_FACT-_PNEUMOCOCCAL_EVALUATION_CHILD_RECEIVED_PCV13_DOSE",
    ...
    SupportedFactConcept(final String pConceptCodeValue, final String pConceptDisplayNameValue)
    {
