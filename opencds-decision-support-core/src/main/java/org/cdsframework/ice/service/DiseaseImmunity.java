...
public class DiseaseImmunity
{
    ...
    public DiseaseImmunity(final String pDiseaseImmunityObtained)
    {
        final String _METHODNAME = "DiseaseImmunity(): ";
        if (pDiseaseImmunityObtained == null)
        {
            final String str = "Disease argument for immunity not supplied";
