...
public class Vaccine extends AbstractVaccine
{
    ...
    public String toString()
    {
        final StringBuilder toStr = new StringBuilder(
                "Vaccine [getCdsListItemName()=%s, isLiveVirusVaccine()=%s, getValidMinimumAgeForUse()=%s, getValidMaximumAgeForUse()=%s, getLicensedMinimumAgeForUse()=%s, getLicensedMaximumAgeForUse()=%s, isUnspecifiedFormulation()=%s, isCombinationVaccine()=%s, isSelectAdjuvantProduct()=%s, VaccineComponent [[ ".formatted(
                        ...
                        isCombinationVaccine(), isSelectAdjuvantProduct()));
