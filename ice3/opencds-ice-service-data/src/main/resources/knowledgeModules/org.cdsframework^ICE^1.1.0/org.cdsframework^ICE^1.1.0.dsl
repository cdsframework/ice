...
[condition][]- [Tt]he [Pp]atient is [Ff]emale=demographics.gender.code == SupportedPersonConcept._GENDER_FEMALE.localCodeValue
[condition][]- [Tt]he [Pp]atient is [Mm]ale=demographics.gender.code == SupportedPersonConcept._GENDER_MALE.localCodeValue
...
[condition][]The [Ii]mmunization [Hh]istory indicates that the [Pp]atient has obtained [Ii]mmunity to {ddSupportedImmunityConcept1Disease} due to reason {ddSupportedEvaluationConcept}=$of : ObservationFocusConcept(openCdsConceptCode == {ddSupportedImmunityConcept1Disease}.getConceptCodeValue()) and $ov : ObservationCodedValueConcept(conceptTargetId == $of.conceptTargetId, openCdsConceptCode == {ddSupportedEvaluationConcept}.getConceptCodeValue()) and $or : ObservationResult(id == $ov.conceptTargetId)
[consequence][]Make [Nn]ote of the [Pp]atient's [Ii]mmunity to {ddSupportedDiseaseConcept} with [Ii]mmunity [Dd]ate as {assign_oDate} and reason {ddSupportedEvaluationConcept} for [Ee]valuation and [Ff]orecasting [Pp]urposes=Date {assign_oDate} = ICELogicHelper.extractSingularDateValueFromIVLDate($or.getObservationEventTime()); DiseaseImmunity diseaseImmunity = new DiseaseImmunity({ddSupportedDiseaseConcept}, {assign_oDate}, {ddSupportedEvaluationConcept}.getConceptCodeValue()); insert(diseaseImmunity);
...
[condition][]- [Tt]he [Ss]hot belongs to the [Vv]accine [Gg]roup {dd_oSupportedVaccineGroupConcept} and the [Ss]eries with [Nn]ame {sSeriesName}=associatedTargetSeries.seriesRules.vaccineGroup == {dd_oSupportedVaccineGroupConcept}, associatedTargetSeries.seriesName == {sSeriesName}
[condition][]- [Tt]he [Ss]hot belongs to the [Vv]accine [Gg]roup {dd_oSupportedVaccineGroupConcept}=associatedTargetSeries.seriesRules.vaccineGroup == {dd_oSupportedVaccineGroupConcept}
...
[condition][]- [Tt]he [Vv]accine [Aa]dministered is not {dd_oSupportedVaccineConcept:[a-zA-Z0-9\\.\\-\\_]+}=vaccineComponent.vaccineConcept.openCdsConceptCode != {dd_oSupportedVaccineConcept}.conceptCodeValue || administeredVaccine.vaccineConcept.openCdsConceptCode != {dd_oSupportedVaccineConcept}.conceptCodeValue
[condition][]- [Tt]he [Vv]accine [Aa]dministered is {dd_oSupportedVaccineConcept:[a-zA-Z0-9\\.\\-\\_]+}=vaccineComponent.vaccineConcept.openCdsConceptCode == {dd_oSupportedVaccineConcept}.conceptCodeValue || administeredVaccine.vaccineConcept.openCdsConceptCode == {dd_oSupportedVaccineConcept}.conceptCodeValue
[condition][]- [Tt]he [Vv]accine [Aa]dministered a member of {list_oSupportedVaccineConcept:[\\(]+[a-zA-Z0-9\\.\\-_\\"\\,\\ \\(\\)]+[\\)]+}=vaccineComponent.vaccineConcept.openCdsConceptCode in {list_oSupportedVaccineConcept} || administeredVaccine.vaccineConcept.openCdsConceptCode in {list_oSupportedVaccineConcept}
[condition][]- [Tt]he [Vv]accine [Aa]dministered not a member of {list_oSupportedVaccineConcept:[\\(]+[a-zA-Z0-9\\.\\-_\\"\\,\\ \\(\\)]+[\\)]+}=vaccineComponent.vaccineConcept.openCdsConceptCode not in {list_oSupportedVaccineConcept} || administeredVaccine.vaccineConcept.openCdsConceptCode not in {list_oSupportedVaccineConcept}
...
[condition][]- [Tt]he [Ss]eries belongs to the [Vv]accine [Gg]roup {dd_oSupportedVaccineGroupConcept}=seriesRules.vaccineGroup == {dd_oSupportedVaccineGroupConcept}
...
[condition][]- [Mm]ake [Nn]ote of the [Vv]accine [Gg]roup that this [Ss]eries belongs to as {assign_enumSupportedVaccineGroupConcept}={assign_enumSupportedVaccineGroupConcept} : seriesRules.vaccineGroup
...
[condition][]Verify that the [Cc]ount of [Dd]oses [Aa]dministered in Series {refer_oTargetSeries} with [Vv]accine {dd_oSupportedVaccineConcept} is {aOp_num}  {nNumberOfDoses}=accumulate($td : TargetDose(status == DoseStatus.VALID, vaccineComponent.vaccineConcept.openCdsConceptCode == {dd_oSupportedVaccineConcept}.conceptCodeValue || $td.administeredVaccine.vaccineConcept.openCdsConceptCode == {dd_oSupportedVaccineConcept}.conceptCodeValue) from {refer_oTargetSeries}.targetDoses; $countNum: count($td); $countNum {aOp_num}  {nNumberOfDoses})
...
[consequence][][Ss]et the [Rr]ecommendation [Vv]accine for {refer_oRecommendation} of [Ss]chedule {refer_oSchedule} to {dd_oSupportedVaccineConcept}={refer_oRecommendation}.setRecommendedVaccine({refer_oSchedule}.getVaccineBySupportedVaccineConceptTypeValue({dd_oSupportedVaccineConcept}));
