...
import org.cdsframework.ice.supportingdata.SupportedCdsVaccines;
...
// (e.g. - CAT). See opencds-ice-service-data/src/main/resources/knowledgeModules/<KmId>/supporting-data/                              //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class ScheduleImpl implements Schedule {
	...
	private List<File> supportingDataLocations;
	...
	// TODO: make configurable and move reading of the supporting data outside of the Schedule class
	...
	public ScheduleImpl(String pScheduleId, List<String> pCdsVersions, File pBaseKnowledgeRepositoryLocation) 
		...
		this.supportingDataLocations = new ArrayList<File>();
		if (this.cdsVersions == null || this.cdsVersions.isEmpty()) {
			String lErrStr = "CDS version(s) not specified";
			logger.error(_METHODNAME + lErrStr);
			throw new ImproperUsageException(lErrStr);
		}
	...
	public List<File> getSupportingDataLocations() {
		return this.supportingDataLocations;
	}
	...
	public Collection<String> getDiseasesTargetedByVaccineGroup(String pVaccineGroupItemName) {
		...
		LocallyCodedVaccineGroupItem lCodedVaccineGroupItem = this.supportedVaccineGroupConcepts.getVaccineGroupItem(pVaccineGroupItemName);
	...
	private void initializeOtherLists(SupportingDataInitializationHelper lISDH) 
		...
		SupportedCdsLists lSLC = lISDH.initializeCodeConcepts(supportingDataConceptsAndCodesSubdirectory);
		if (logger.isDebugEnabled()) {
			String lDebugStr = _METHODNAME + "The following lists have been initialized into the " + this.getClass().getName() + ": \n";
			lDebugStr += lSLC.toString();
	...
	private void initializeVaccineGroupDiseases(SupportingDataInitializationHelper lISDH) 
		...
		**/
		...
		String _METHODNAME = "initializeVaccineGroupDiseases(): ";
		if (lISDH == null) {
			return;
		}
		SupportedCdsVaccineGroups lSVGC = lISDH.initializeVaccineGroupSupportingData(supportingDataVaccineGroupsSubdirectory, this.supportedListConcepts);
		if (logger.isDebugEnabled()) {
			String lDebugStr = _METHODNAME + "The following Vaccine Groups have been initialized into the " + this.getClass().getName() + ": \n";
			lDebugStr += lSVGC.toString();
			logger.debug(_METHODNAME + lDebugStr);
		}
	...
	private void initializeVaccines(SupportingDataInitializationHelper lISDH) 
		...
		SupportedCdsVaccines lSVs = lISDH.initializeVaccineSupportingData(supportingDataVaccinesSubdirectory, this.supportedListConcepts);
		if (logger.isDebugEnabled()) {
			String lDebugStr = _METHODNAME + "The following Vaccines have been initialized into the " + this.getClass().getName() + ": \n";
			lDebugStr += lSVs.toString();
			logger.debug(_METHODNAME + lDebugStr);
		}
		this.supportedVaccineConcepts = lSVs;
	}
	...
	private void initializeVaccines() {
		...
		// lVaccineComponent.setValidMaximumAgeForUse(new TimePeriod(20, DurationType.YEARS, false));
		...
		// lVaccine.setValidMaximumAgeForUse(new TimePeriod(20, DurationType.YEARS, false));
		...
		diseaseImmunityList.add(SupportedDiseaseConcept.Pertussis);
		diseaseImmunityList.add(SupportedDiseaseConcept.Hib);
l		numberOfVGsEncompassingDiseases = getNumberOfVaccineGroupsEncompassingDiseases(diseaseImmunityList);
		if (numberOfVGsEncompassingDiseases > 1) {
			numberOfVGsGreaterThanOne = true;
		}
		else {
	...
	*/
	...
	private int getCountOfVaccineGroupsEncompassingDiseases(List<String> pSDCs) {
		...
		int i=0;
		Collection<LocallyCodedVaccineGroupItem> lAllVaccineGroups = this.supportedVaccineGroupConcepts.getAllLocallyCodedVaccineGroupItems();
