...
public class VaccineComponentSD extends AbstractVaccine {
	...
	private VaccineComponentSD(VaccineComponentSD pVaccineComponent) {
	 ...
	 */
	public static VaccineComponentSD constructDeepCopyOfVaccineComponentObject(VaccineComponentSD pV) { 
